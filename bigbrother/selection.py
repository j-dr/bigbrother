...
class Selector:
    ...
    def cut2DHelper(self, mapunit, selection, i):
        ...
        if (len(selection['mapkeys'][0])) > 1:
            if selection['selection_ind'][0][0] == None:
                if selection['selection_ind'][0][1] == None:
                    field1 = mapunit[selection['mapkeys'][0][0]] - mapunit[selection['mapkeys'][0][1]]
                    if selection['selection_ind'][1][0] == None:
                        if selection['selection_ind'][1][1] == None:
                            field2 = mapunit[selection['mapkeys'][1][0]] - mapunit[selection['mapkeys'][1][1]]
                        else:
                            field2 = mapunit[selection['mapkeys'][1][0]] - mapunit[selection['mapkeys'][1][1]][:,selection['selection_ind'][1][1]]
                    else:
                        if selection['selection_ind'][1][1] == None:
                            field2 = mapunit[selection['mapkeys'][1][0]][:,selection['selection_ind'][1][0]] - mapunit[selection['mapkeys'][1][1]]
                        else:
                    ...
                    field1 = mapunit[selection['mapkeys'][0][0]] - mapunit[selection['mapkeys'][0][1]][:,selection['selection_ind'][0][1]]
                    if selection['selection_ind'][1][0] == None:
                        if selection['selection_ind'][1][1] == None:
                            field2 = mapunit[selection['mapkeys'][1][0]] - mapunit[selection['mapkeys'][1][1]]
                        else:
                ...
                if selection['selection_ind'][0][1] == None:
                    field1 = field1 = mapunit[selection['mapkeys'][0][0]][:,selection['selection_ind'][0][0]] - mapunit[selection['mapkeys'][0][1]]
                    if selection['selection_ind'][1][0] == None:
                        if selection['selection_ind'][1][1] == None:
                            field2 = mapunit[selection['mapkeys'][1][0]] - mapunit[selection['mapkeys'][1][1]]
                        else:
